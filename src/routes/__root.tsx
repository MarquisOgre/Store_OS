...
import { AppShell } from "@/components/storeos/AppShell";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://store-os-ten.vercel.app/" },
      { property: "og:image", content: "https://store-os-ten.vercel.app/StoreOS.png" },
      { property: "og:image:type", content: "image/png" },
      { property: "og:image:width", content: "2172" },
      { property: "og:image:height", content: "725" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://store-os-ten.vercel.app/StoreOS.png" },
    ],
    links: [
      ...
      { rel: "icon", href: "/StoreOS.png", type: "image/png" },
      { rel: "apple-touch-icon", href: "/StoreOS.png" },
    ],
  }),
